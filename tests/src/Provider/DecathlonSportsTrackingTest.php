...
class DecathlonSportsTrackingTest extends \PHPUnit_Framework_TestCase
{
    protected $provider;
    ...
    {
        $this->provider = new \League\OAuth2\Client\Provider\DecathlonSportsTracking(
            [
    ...
    public function testDecathlonSportsTrackingLinkDomainUrls()
    {
